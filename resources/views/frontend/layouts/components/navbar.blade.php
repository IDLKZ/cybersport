        ...
        <div class="container-fluid">
            <nav class="navbar navbar-expand-md navbar-light">
                ...
                <div class="collapse navbar-collapse mean-menu">
                    <ul class="navbar-nav">
                        <li class="nav-item"><a href="index-2.html#" class="nav-link active">Home <i class="flaticon-down-arrow"></i></a>
                            <ul class="dropdown-menu">
                                <li class="nav-item"><a href="index.html" class="nav-link">Main Home</a></li>

                                <li class="nav-item"><a href="index-2.html" class="nav-link active">Esports Home</a></li>
                        ...
                        <li class="nav-item"><a href="index-2.html#" class="nav-link">Pages <i class="flaticon-down-arrow"></i></a>
                            <ul class="dropdown-menu">
                        ...
                        <li class="nav-item"><a href="index-2.html#" class="nav-link">Tournament <i class="flaticon-down-arrow"></i></a>
                            <ul class="dropdown-menu">
                        ...
                        <li class="nav-item"><a href="index-2.html#" class="nav-link">Shop <i class="flaticon-down-arrow"></i></a>
                            <ul class="dropdown-menu">
                        ...
                        <li class="nav-item"><a href="index-2.html#" class="nav-link">Blog <i class="flaticon-down-arrow"></i></a>
                            <ul class="dropdown-menu">
                                ...
                                <li class="nav-item"><a href="index-2.html#" class="nav-link">Single Post <i class='bx bx-plus'></i></a>
                                    <ul class="dropdown-menu">
